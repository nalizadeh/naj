 ...
 * @author  P203125
 */
public class JTreeTableXTest extends JPanel {

	private static final long serialVersionUID = 1L;

	private static final String[] columnNames = { "Name", "Size", "Directory", "Modification Date" };
	private JTreeTableX treetable = null;
	private FileNode root = null;

	public JTreeTableXTest(final String path, final String pattern) {
		...
		btWorkDir.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					int returnVal = chooser.showOpenDialog(JTreeTableXTest.this);
	...
	private void makeTreeTable() {
		treetable = new JTreeTableX(columnNames);
		treetable.init(root);
	 ...
	 * @author  P203125
	 */
	private static class FileNode extends JTreeTableX.TreeTableNode {
		...
		private JTreeTableX.IconRendererComponent pp =
			new JTreeTableX.IconRendererComponent() {
				private static final long serialVersionUID = 1L;
		...
		@Override
		public void copy(JTreeTableX.TreeTableNode node) {
		...
		@Override
		public JTreeTableX.RendererComponent getRenderer(int row, int column) {
	...
	public static void main(String[] args) {
		...
		JTreeTableXTest table = new JTreeTableXTest("C:\\Users\\Default\\", ".*");
